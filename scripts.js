  ...
  document.querySelector('main').addEventListener("click", function (det) {
    if (!animating) {
      ...
      gsap.to(h1s[index], {
        ...
        duration: 1,
        onComplete: function () {
          gsap.set(this._targets[0], { top: "80%" });
          animating = false;
        }
      });
